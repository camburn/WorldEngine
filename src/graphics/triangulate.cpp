...
This snippet actually compiles directly to a little test application. 
It uses STL to act as a container for the polygon outline and the triangulated
results. By simply replacing the Vector2d class with whatever your own favorite 
Vector class might be you can easily adapt it to your own application. 
It could also be reworked as a template class that could operate on any vertice
type of any kind.
